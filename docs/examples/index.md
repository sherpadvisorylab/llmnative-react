...
- [CRUD basic](crud-basic.md) shows a simple Grid + Form user-management flow.
- [CRUD modal](crud-modal.md) shows inline list actions with modal editing.
- [Nested form](form-nested.md) shows dot notation and repeatable data.
