...
- Keep operational files such as `CHANGE_REQUESTS.md`, `STATUS.md` and `ROADMAP.md` at the `docs/` root. They are internal project-management docs, readable for AI and contributors, but without `path` frontmatter unless they should appear in the sidebar.
