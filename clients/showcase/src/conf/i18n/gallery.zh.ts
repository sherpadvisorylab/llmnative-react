...
export default defineLocaleMessages({
    showcase: {
        gallery: {
            ...
            sections: {
                sortedGallery: { title: 'Sorted gallery', description: 'Gallery accepts the same sortable contract as Grid and Table. It sorts incoming records before rendering, without needing a header UI.' },
            ...
            propsDocs: {
                ...
                items: {
                    ...
                    pagination: { description: 'Shared pagination config.' },
                    gap: { description: 'Item padding size.' },
                    columns: { description: 'Columns per row.' },
                    groupBy: { description: 'Group cards by a field name. Records with the same field value are rendered inside the same section. Pass an array for multi-level grouping.', placeholder: 'e.g. category or ["category","status"]' },
