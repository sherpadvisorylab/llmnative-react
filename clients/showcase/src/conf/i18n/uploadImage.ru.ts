        ...
        uploadImage: {
            ...
            sections: {
                ...
                editableCrop: {
                    ...
                    description: 'Добавьте editable, чтобы при наведении показывать иконку карандаша. По клику откроется редактор изображений с инструментами обрезки и масштаба, а также полем альтернативного текста (независимо от srcset/вариантов — одно описание на изображение), и всё сохранится в этой записи файла внутри Form.',
                },
                acceptFilter: {
                    title: 'Фильтр accept',
