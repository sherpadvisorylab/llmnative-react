    ...
    showcase: {
        promptLive: {
            ...
            sections: {
                ...
                variablesResolvedPreview: { title: 'Variables - resolved preview', description: 'Pass variables to inject external values into the template. Click the gear to enter edit mode, then use the eye icon in the footer bar to inspect a read-only preview of the fully resolved prompt before running it.' },
