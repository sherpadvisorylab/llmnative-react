...
export default defineLocaleMessages({
    showcase: {
        codeEditor: {
            page: { title: 'CodeEditor', description: 'Code editor with syntax highlighting powered by CodeMirror 6. Lazy-loaded only when mounted. Supports HTML, JSON, JavaScript, TypeScript, CSS and Liquid syntax.' },
            sections: {
                basicUsage: { title: 'Basic usage', description: 'Drop CodeEditor inside a Form like any other field.' },
                languageModes: { title: 'Language modes', description: 'Pass language="json", "js", "ts", "css" or "liquid" to switch the syntax highlighter.' },
                disabledState: { title: 'Disabled', description: 'The disabled prop makes the editor read-only.' },
            },
            labels: { templateBody: 'Template body', jsonConfig: 'JSON config', script: 'Script', stylesheet: 'Stylesheet', liquidTemplate: 'Liquid template', startCoding: 'Start coding…' },
            propsDocs: {
