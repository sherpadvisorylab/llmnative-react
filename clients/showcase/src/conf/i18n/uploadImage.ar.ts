        ...
        uploadImage: {
            ...
            sections: {
                ...
                editableCrop: {
                    ...
                    description: 'أضف editable لإظهار أيقونة القلم عند التحويم. يؤدي النقر عليها إلى فتح محرر الصور مع أدوات القص والتكبير بالإضافة إلى حقل نص بديل (مستقل عن srcset/النسخ — وصف واحد لكل صورة)، ويُحفظ كل ذلك داخل إدخال الملف في سجل Form.',
                },
                acceptFilter: {
                    title: 'مرشح accept',
