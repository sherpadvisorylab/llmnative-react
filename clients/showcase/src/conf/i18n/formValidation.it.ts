    ...
    showcase: {
        formValidation: {
            ...
            sections: {
                ...
                insideModal: { title: 'Form dentro un modal', description: 'Un form validato può vivere dentro un Modal in qualsiasi posizione. Il pulsante Salva del modal può chiamare un FormController condiviso: la validazione viene eseguita, gli errori appaiono in linea e il modal si chiude solo quando tutti i campi sono validi.' },
            },
        },
    },
});
