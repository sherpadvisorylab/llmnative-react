...
const menuConfig = {
    ...
    components: [
        ...
        { path: '/components/input',      title: 'Input',      page: s('Input',  'Text, number, email, password, color, date, datetime, week, month variants.'), group: 'Form fields' },
        { path: '/components/select',     title: 'Select',     page: s('Select', 'Static options, Firebase-backed, Autocomplete and Checklist variants.'),      group: 'Form fields' },
        ...
        { path: '/components/form',       title: 'Form',       page: s('Form widget', 'Full CRUD form: load, validate, save, delete with lifecycle hooks.'),     group: 'Widgets' },
        { path: '/components/grid',       title: 'Grid',       page: s('Grid widget', 'Real-time CRUD table and gallery with sorting, pagination and modal edit.'), group: 'Widgets' },
    ],
