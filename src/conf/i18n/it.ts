...
export const it: I18nDict = {
    ...
    upload: {
        ...
        insertFromUrl: 'Inserisci da URL', urlPlaceholder: 'https://…/immagine.png',
    ...
    prompt: {
        ...
        attachFiles: 'Allega file', dropFilesHere: 'Rilascia i file per allegarli', modelPricing: 'Input / output, USD per 1M token', modelPriceNotFound: 'Prezzo non trovato', attachmentsNotSupported: 'Il provider AI selezionato non supporta allegati immagini o documenti.',
