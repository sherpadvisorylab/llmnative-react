...
export const ru: I18nDict = {
    ...
    prompt: {
        ...
        aiNotConfiguredShort: 'AI не настроен',
        ...
        attachFiles: 'Прикрепить файлы', attachmentsNotSupported: 'Выбранный AI-провайдер не поддерживает изображения или документы.',
