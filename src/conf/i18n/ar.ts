...
export const ar: I18nDict = {
    ...
    prompt: {
        ...
        aiNotConfiguredShort: 'AI غير مكوّن',
        ...
        attachFiles: 'إرفاق الملفات', dropFilesHere: 'أفلت الملفات هنا لإرفاقها', modelPricing: 'الإدخال / الإخراج، دولار أمريكي لكل مليون رمز', modelPriceNotFound: 'السعر غير متوفر', attachmentsNotSupported: 'مزوّد AI المحدد لا يدعم مرفقات الصور أو المستندات.',
        ...
        tokenOutput: 'خرج: {count} tok', tokenContext: 'السياق: {percent}%',
        tokenCost: 'التكلفة: ~${amount}', tokenTime: 'الوقت: {seconds}ث',
        tokenUsageEmpty: 'شغّل الأمر لعرض إحصائيات الرموز.',
        hidePreview: 'إخفاء المعاينة', showPreview: 'عرض المعاينة المحلولة',
        noProvider: 'لا يوجد مزود AI متاح لهذا الأمر.',
